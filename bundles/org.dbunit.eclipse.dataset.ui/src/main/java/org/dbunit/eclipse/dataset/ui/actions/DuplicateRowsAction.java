...
/**
 * Inserts copies of the selected rows directly after them, in their order, and selects the new block.
 *
 * @since 1.0.0
 */
public final class DuplicateRowsAction extends GridAction
{
    /**
     * Creates the action.
     *
