...
/**
 * Moves a contiguous block of selected rows down by one position and keeps it selected.
 *
 * @since 1.0.0
 */
public final class MoveRowsDownAction extends GridAction
{
    /**
     * Creates the action.
     *
    ...
    {
        return selection.isContiguousRowSelection()
                && selection.lastRowIndex() < selection.rowCount() - 1;
    }
}
